...
## [0.65.0](https://github.com/aquasecurity/trivy-test/compare/v0.64.0...v0.65.0) (2025-07-22)


### ⚠ BREAKING CHANGES

* **k8s:** support k8s multi container ([#7444](https://github.com/aquasecurity/trivy-test/issues/7444))
...
* add `workspaceRelationship` ([#7889](https://github.com/aquasecurity/trivy-test/issues/7889)) ([d622ca2](https://github.com/aquasecurity/trivy-test/commit/d622ca2b1fe40a0eb588478ba9e15d3bd8471a78))
...
* add cvss v4 score and vector in scan response ([#7968](https://github.com/aquasecurity/trivy-test/issues/7968)) ([e0f2054](https://github.com/aquasecurity/trivy-test/commit/e0f2054f9d12dce87e8a0226350f6317f7167195))
* add end of life date for Ubuntu 24.10 ([#7787](https://github.com/aquasecurity/trivy-test/issues/7787)) ([ad3c09e](https://github.com/aquasecurity/trivy-test/commit/ad3c09e006e134f3c5b879ffc34ce9895a8c860f))
...
* **cli:** add `trivy auth` ([#7664](https://github.com/aquasecurity/trivy-test/issues/7664)) ([27117f8](https://github.com/aquasecurity/trivy-test/commit/27117f81d52483c3ceec56fe56ac298e242fbc9a))
...
* **cli:** error out when ignore file cannot be found ([#7624](https://github.com/aquasecurity/trivy-test/issues/7624)) ([cb0b3a9](https://github.com/aquasecurity/trivy-test/commit/cb0b3a9279b31810ecd686a385e5140e567ce86f))
* **cli:** rename `trivy auth` to `trivy registry` ([#7727](https://github.com/aquasecurity/trivy-test/issues/7727)) ([633a7ab](https://github.com/aquasecurity/trivy-test/commit/633a7abeea4287899392a24f2705f96dfeb7e312))
* **cyclonedx:** add file checksums to `CycloneDX` reports ([#7507](https://github.com/aquasecurity/trivy-test/issues/7507)) ([c225883](https://github.com/aquasecurity/trivy-test/commit/c225883649f58128a99fa2c1cef327d0e57940be))
* **cyclonedx:** Add initial support for loading external VEX files from SBOM references ([#8254](https://github.com/aquasecurity/trivy-test/issues/8254)) ([4820eb7](https://github.com/aquasecurity/trivy-test/commit/4820eb70fc926a35d759c373112dbbdca890fd46))
* **db:** append errors ([#7843](https://github.com/aquasecurity/trivy-test/issues/7843)) ([5e78b6c](https://github.com/aquasecurity/trivy-test/commit/5e78b6c12fb5740c12dedeea3d335d48ec2f752b))
...
* **go:** construct dependencies in the parser ([#7973](https://github.com/aquasecurity/trivy-test/issues/7973)) ([bcdc0bb](https://github.com/aquasecurity/trivy-test/commit/bcdc0bbf1f63777ff79d3ecadb8d4f916f376b7d))
* **go:** construct dependencies of `go.mod` main module in the parser ([#7977](https://github.com/aquasecurity/trivy-test/issues/7977)) ([5448ba2](https://github.com/aquasecurity/trivy-test/commit/5448ba2a5c1ee36cbcf74ee1c2e83409092c5715))
...
* **k8s:** add default commands for unknown platform ([#7863](https://github.com/aquasecurity/trivy-test/issues/7863)) ([b1c7f55](https://github.com/aquasecurity/trivy-test/commit/b1c7f5516fc39c6cbb76cbeae5c8677ccc9ce5dd))
...
* **misconf:** export unresolvable field of IaC types to Rego ([#7765](https://github.com/aquasecurity/trivy-test/issues/7765)) ([9514148](https://github.com/aquasecurity/trivy-test/commit/9514148767865baddd73a49245385574927f7a74))
* **misconf:** generate placeholders for random provider resources ([#8051](https://github.com/aquasecurity/trivy-test/issues/8051)) ([ffe24e1](https://github.com/aquasecurity/trivy-test/commit/ffe24e18dc3dca816ec9ce5ccf66d5d7b5ea70d6))
* **misconf:** log causes of HCL file parsing errors ([#7634](https://github.com/aquasecurity/trivy-test/issues/7634)) ([e9a899a](https://github.com/aquasecurity/trivy-test/commit/e9a899a3cfe41a622202808a0241b7f40b54d338))
...
* **misconf:** public network support for Azure Storage Account ([#7601](https://github.com/aquasecurity/trivy-test/issues/7601)) ([ad91412](https://github.com/aquasecurity/trivy-test/commit/ad914123c4d203af1e1da6b7e2d3e49d9d3831d8))
...
* **misconf:** Show misconfig ID in output ([#7762](https://github.com/aquasecurity/trivy-test/issues/7762)) ([f75c0d1](https://github.com/aquasecurity/trivy-test/commit/f75c0d1f0069d4856cb4826d6049f32c5b9409d9))
* **misconf:** ssl_mode support for GCP SQL DB instance ([#7564](https://github.com/aquasecurity/trivy-test/issues/7564)) ([2eaa17e](https://github.com/aquasecurity/trivy-test/commit/2eaa17e0717940b27a79050e2efd9213b71178c9))
...
* **nodejs:** respect peer dependencies for dependency tree ([#7989](https://github.com/aquasecurity/trivy-test/issues/7989)) ([7389961](https://github.com/aquasecurity/trivy-test/commit/73899610e8eece670d2e5ddc1478fcc0a2a5760d))
* **oracle:** add `flavors` support ([#7858](https://github.com/aquasecurity/trivy-test/issues/7858)) ([b9b383e](https://github.com/aquasecurity/trivy-test/commit/b9b383eb2714e88357af75900c856db2900b83ec))
* **parser:** ignore white space in pom.xml files ([#7747](https://github.com/aquasecurity/trivy-test/issues/7747)) ([a7baa93](https://github.com/aquasecurity/trivy-test/commit/a7baa93b00b8636aa097e64cdb8eed97dbd68511))
...
* **report:** update gitlab template to populate operating_system value ([#7735](https://github.com/aquasecurity/trivy-test/issues/7735)) ([c0d79fa](https://github.com/aquasecurity/trivy-test/commit/c0d79fa09e645f3a3dbff878e393b8631fb17b64))
...
* **secret:** Add built-in secrets rules for Private Packagist ([#7826](https://github.com/aquasecurity/trivy-test/issues/7826)) ([132d9df](https://github.com/aquasecurity/trivy-test/commit/132d9dfa19a8835c94f332c6939ab7f64641ee5f))
* support RPM archives ([#7628](https://github.com/aquasecurity/trivy-test/issues/7628)) ([69bf7e0](https://github.com/aquasecurity/trivy-test/commit/69bf7e00ea5ab483692db830fdded26a31f03183))
* **suse:** Align SUSE/OpenSUSE OS Identifiers ([#7965](https://github.com/aquasecurity/trivy-test/issues/7965)) ([45d3b40](https://github.com/aquasecurity/trivy-test/commit/45d3b40044202dec91384847ce2b50a7271f5977))
...
* Update registry fallbacks ([#7679](https://github.com/aquasecurity/trivy-test/issues/7679)) ([5ba9a83](https://github.com/aquasecurity/trivy-test/commit/5ba9a83a447c4f9e577ae6235c315df71f50b452))
...
* **alpine:** add `UID` for removed packages ([#7887](https://github.com/aquasecurity/trivy-test/issues/7887)) ([07915da](https://github.com/aquasecurity/trivy-test/commit/07915da4816d4d9ec8a6c5e4cba17be2a0f4ad65))
...
* **aws:** change CPU and Memory type of ContainerDefinition to a string ([#7995](https://github.com/aquasecurity/trivy-test/issues/7995)) ([aeeba70](https://github.com/aquasecurity/trivy-test/commit/aeeba70d15c11443d9fe7c26f90fc7d9dcc7f92c))
...
* **cli:** `clean --all` deletes only relevant dirs ([#7704](https://github.com/aquasecurity/trivy-test/issues/7704)) ([672e886](https://github.com/aquasecurity/trivy-test/commit/672e886aed152ae0f09a16941706746f3053ca94))
* **cli:** add config name to skip-policy-update alias ([#7820](https://github.com/aquasecurity/trivy-test/issues/7820)) ([b661d68](https://github.com/aquasecurity/trivy-test/commit/b661d680ff0372c8e4beea0db13bf69d6a2203a8))
...
* **cli:** Handle empty ignore files more gracefully ([#7962](https://github.com/aquasecurity/trivy-test/issues/7962)) ([4cfb2a9](https://github.com/aquasecurity/trivy-test/commit/4cfb2a97b27923182ab45c178544542ec65981d4))
...
* CVE-2024-45337: Misuse of ServerConfig.PublicKeyCallback may cause authorization bypass ([#8088](https://github.com/aquasecurity/trivy-test/issues/8088)) ([d7ac286](https://github.com/aquasecurity/trivy-test/commit/d7ac286085077c969734225a789e6cc056d5c5f5))
...
* **db:** fix javadb downloading error handling ([#7642](https://github.com/aquasecurity/trivy-test/issues/7642)) ([2c87f0c](https://github.com/aquasecurity/trivy-test/commit/2c87f0cb794acd77446a273582ba1a45b9f18980))
...
* **debian:** infinite loop ([#7928](https://github.com/aquasecurity/trivy-test/issues/7928)) ([d982e6a](https://github.com/aquasecurity/trivy-test/commit/d982e6ab89967629f71ec09100cdc61e30a27c63))
...
* enable usestdlibvars linter ([#7770](https://github.com/aquasecurity/trivy-test/issues/7770)) ([57e24aa](https://github.com/aquasecurity/trivy-test/commit/57e24aa85382f749df7f673e241caaf3fcbb45cb))
...
* **flag:** skip hidden flags for `--generate-default-config` command ([#8046](https://github.com/aquasecurity/trivy-test/issues/8046)) ([5e68bdc](https://github.com/aquasecurity/trivy-test/commit/5e68bdc9d08f96d22451d7b5dd93e79ca576eeb7))
* **fs:** add missing defered Cleanup() call to post analyzer fs ([#7882](https://github.com/aquasecurity/trivy-test/issues/7882)) ([ab32297](https://github.com/aquasecurity/trivy-test/commit/ab32297e0a8220a427fa330025f8625281e02275))
...
* **go:** Do not trim v prefix from versions in Go Mod Analyzer ([#7733](https://github.com/aquasecurity/trivy-test/issues/7733)) ([e872ec0](https://github.com/aquasecurity/trivy-test/commit/e872ec006c0745a5a142728af0096c6d6bb9ddf3))
...
* **helm:** properly handle multiple archived dependencies ([#7782](https://github.com/aquasecurity/trivy-test/issues/7782)) ([6fab88d](https://github.com/aquasecurity/trivy-test/commit/6fab88dd56c257ef2cc63b617c2a5decb1c4cf98))
...
* improve security by using environment variables in canary workflow ([3d4152d](https://github.com/aquasecurity/trivy-test/commit/3d4152dc8b0c1a760b7c61f02623c0a79bb48463))
* Improve version comparisons when build identifiers are present ([#7873](https://github.com/aquasecurity/trivy-test/issues/7873)) ([eda4d76](https://github.com/aquasecurity/trivy-test/commit/eda4d7660d8908705bc08a6edc55d8144d02806a))
* **java:** correctly inherit `version` and `scope` from upper/root `depManagement` and `dependencies` into parents ([#7541](https://github.com/aquasecurity/trivy-test/issues/7541)) ([778df82](https://github.com/aquasecurity/trivy-test/commit/778df828eaad9827cb833c6285058a33aa2b83ca))
* **java:** correctly overwrite version from depManagement if dependency uses `project.*` props ([#8050](https://github.com/aquasecurity/trivy-test/issues/8050)) ([9d9f80d](https://github.com/aquasecurity/trivy-test/commit/9d9f80d9791f38a0b4c727152166ae4d237a83a9))
...
* **k8s:** check all results for vulnerabilities ([#7946](https://github.com/aquasecurity/trivy-test/issues/7946)) ([797b36f](https://github.com/aquasecurity/trivy-test/commit/797b36fbad90b8e7f04e16e2cf08d6bdc0255ac7))
...
* **k8s:** skip resources without misconfigs ([#7797](https://github.com/aquasecurity/trivy-test/issues/7797)) ([7882776](https://github.com/aquasecurity/trivy-test/commit/78827768a612ab305bf9c55409ce76d6774302a5))
* **k8s:** support k8s multi container ([#7444](https://github.com/aquasecurity/trivy-test/issues/7444)) ([c434775](https://github.com/aquasecurity/trivy-test/commit/c4347759234dcb5f372b07f92fb4230ef391d710))
* **k8s:** support kubernetes v1.31 ([#7810](https://github.com/aquasecurity/trivy-test/issues/7810)) ([7a4f4d8](https://github.com/aquasecurity/trivy-test/commit/7a4f4d8b12996687f3095a2042cdf2f5985332c9))
...
* **license:** fix license normalization for Universal Permissive License ([#7766](https://github.com/aquasecurity/trivy-test/issues/7766)) ([f6acdf7](https://github.com/aquasecurity/trivy-test/commit/f6acdf713991f8ffdbe765178fcb8a9cde433cba))
...
* **misconf:** change default ACL of digitalocean_spaces_bucket to private ([#7577](https://github.com/aquasecurity/trivy-test/issues/7577)) ([9da84f5](https://github.com/aquasecurity/trivy-test/commit/9da84f54fadbe6ad0d73983952e945ed63b666f3))
...
* **misconf:** check if property is not nil before conversion ([#7578](https://github.com/aquasecurity/trivy-test/issues/7578)) ([c8c14d3](https://github.com/aquasecurity/trivy-test/commit/c8c14d36245623019f29d258f813d2325f7490f7))
* **misconf:** Check values wholly prior to evalution ([#8604](https://github.com/aquasecurity/trivy-test/issues/8604)) ([ad58cf4](https://github.com/aquasecurity/trivy-test/commit/ad58cf4457ebef80ff0bc4c113d4ab4c86a9fe56))
...
* **misconf:** Disable deprecated checks by default ([#7632](https://github.com/aquasecurity/trivy-test/issues/7632)) ([82e2adc](https://github.com/aquasecurity/trivy-test/commit/82e2adc6f8e68d0cc0021031170c2adb60d213ba))
...
* **misconf:** do not erase variable type for child modules ([#7941](https://github.com/aquasecurity/trivy-test/issues/7941)) ([de3b7ea](https://github.com/aquasecurity/trivy-test/commit/de3b7ea24c282bce22ce9cacb49a43d8d90e2bde))
...
* **misconf:** fix for Azure Storage Account network acls adaptation ([#7602](https://github.com/aquasecurity/trivy-test/issues/7602)) ([35fd018](https://github.com/aquasecurity/trivy-test/commit/35fd018ae7ad86823f114f0ac2f1376726aee444))
...
* **misconf:** handle null properties in CloudFormation templates ([#7813](https://github.com/aquasecurity/trivy-test/issues/7813)) ([99b2db3](https://github.com/aquasecurity/trivy-test/commit/99b2db3978562689cef956a71281abb84ff0ce47))
...
* **misconf:** load full Terraform module ([#7925](https://github.com/aquasecurity/trivy-test/issues/7925)) ([fbc42a0](https://github.com/aquasecurity/trivy-test/commit/fbc42a04ea24e2246f81491434a965846d55ed69))
...
* **misconf:** not to warn about missing selectors of libraries ([#7638](https://github.com/aquasecurity/trivy-test/issues/7638)) ([fcaea74](https://github.com/aquasecurity/trivy-test/commit/fcaea740808d5784c120e5c5d65f5f94e1d931d4))
...
* **misconf:** populate context correctly for module instances ([#8656](https://github.com/aquasecurity/trivy-test/issues/8656)) ([efd177b](https://github.com/aquasecurity/trivy-test/commit/efd177b300950d82e381992e1dea39308cc39bc3))
* **misconf:** properly expand dynamic blocks ([#7612](https://github.com/aquasecurity/trivy-test/issues/7612)) ([8d5dbc9](https://github.com/aquasecurity/trivy-test/commit/8d5dbc9fec3569b22ed81a03c40eaf732768718b))
* **misconf:** properly resolve local Terraform cache ([#7983](https://github.com/aquasecurity/trivy-test/issues/7983)) ([fe3a897](https://github.com/aquasecurity/trivy-test/commit/fe3a8971b6697d896c1ec30b5326a10c20349d14))
...
* **misconf:** Update trivy-checks default repo to `mirror.gcr.io` ([#7953](https://github.com/aquasecurity/trivy-test/issues/7953)) ([9988147](https://github.com/aquasecurity/trivy-test/commit/9988147b8b0e463464fe494122bfcc66ccdf04e0))
...
* **misconf:** use log instead of fmt for logging ([#8033](https://github.com/aquasecurity/trivy-test/issues/8033)) ([07b2d7f](https://github.com/aquasecurity/trivy-test/commit/07b2d7fbd7f8ef5473c2438c560fffc8bdadf913))
* **misconf:** wrap AWS EnvVar to iac types ([#7407](https://github.com/aquasecurity/trivy-test/issues/7407)) ([54130dc](https://github.com/aquasecurity/trivy-test/commit/54130dcc1d775506d34b83a558952176fc549914))
...
* move runner.os context from job-level env to step-level in canary workflow ([8a73f82](https://github.com/aquasecurity/trivy-test/commit/8a73f826f78c60f24c63027f9404cb71d456d07d))
...
* **python:** add `poetry` v2 support ([#8323](https://github.com/aquasecurity/trivy-test/issues/8323)) ([10cd98c](https://github.com/aquasecurity/trivy-test/commit/10cd98cf55263749cb2583063a2e9e9953c7371a))
...
* **redhat:** don't return error if `root/buildinfo/content_manifests/` contains files that are not `contentSets` files ([#7912](https://github.com/aquasecurity/trivy-test/issues/7912)) ([38775a5](https://github.com/aquasecurity/trivy-test/commit/38775a5ed985eefe2b410e72407c454cdad3d075))
* **redhat:** include arch in PURL qualifiers ([#7654](https://github.com/aquasecurity/trivy-test/issues/7654)) ([a585e95](https://github.com/aquasecurity/trivy-test/commit/a585e95f3398631d9ad10505c5ff642fde21aef7))
...
* **repo:** `git clone` output to Stderr ([#7561](https://github.com/aquasecurity/trivy-test/issues/7561)) ([fdf203c](https://github.com/aquasecurity/trivy-test/commit/fdf203cd209aeb40f454bd12d121a54d6ed7a542))
...
* **report:** Fix invalid URI in SARIF report ([#7645](https://github.com/aquasecurity/trivy-test/issues/7645)) ([015bb88](https://github.com/aquasecurity/trivy-test/commit/015bb885ac414b91201fa9791eead395d878149c))
* **report:** handle `git@github.com` schema for misconfigs in `sarif` report ([#7898](https://github.com/aquasecurity/trivy-test/issues/7898)) ([19aea4b](https://github.com/aquasecurity/trivy-test/commit/19aea4b01f3ce5a3cd05d5a1091da5b0b3ba4af6))
...
* respect GITHUB_TOKEN to download artifacts from GHCR ([#7580](https://github.com/aquasecurity/trivy-test/issues/7580)) ([21b68e1](https://github.com/aquasecurity/trivy-test/commit/21b68e18188f91935ac1055a78ee97a7f35a110d))
...
* **sbom:** add options for DBs in private registries ([#7660](https://github.com/aquasecurity/trivy-test/issues/7660)) ([1f2e91b](https://github.com/aquasecurity/trivy-test/commit/1f2e91b02b3606dd11963002a8cfac7962f3478f))
...
* **sbom:** fix wrong overwriting of applications obtained from different sbom files but having same app type ([#8052](https://github.com/aquasecurity/trivy-test/issues/8052)) ([fd07074](https://github.com/aquasecurity/trivy-test/commit/fd07074e8033530eee2732193b00e59f27c73096))
* **sbom:** Fixes for Programming Language Vulnerabilities and SBOM Package Maintainer Details ([#7871](https://github.com/aquasecurity/trivy-test/issues/7871)) ([461a68a](https://github.com/aquasecurity/trivy-test/commit/461a68afd60b77dd67e91047b3b4d558fa5bd2ec))
...
* **sbom:** preserve OS packages from multiple SBOMs ([#8325](https://github.com/aquasecurity/trivy-test/issues/8325)) ([bd5baaf](https://github.com/aquasecurity/trivy-test/commit/bd5baaf93054d71223e0721c7547a0567dea3b02))
...
* **sbom:** use `Annotation` instead of `AttributionTexts` for `SPDX` formats ([#7811](https://github.com/aquasecurity/trivy-test/issues/7811)) ([f2bb9c6](https://github.com/aquasecurity/trivy-test/commit/f2bb9c6227743dd61f44eb591d4b15192fe110c6))
...
* **secret:** change grafana token regex to find them without unquoted ([#7627](https://github.com/aquasecurity/trivy-test/issues/7627)) ([3e1fa21](https://github.com/aquasecurity/trivy-test/commit/3e1fa2100074e840bacdd65947425b08750b7d9a))
...
* **terraform:** hcl object expressions to return references ([#8271](https://github.com/aquasecurity/trivy-test/issues/8271)) ([0d3efa5](https://github.com/aquasecurity/trivy-test/commit/0d3efa5dc150dba437d975a2f8335de8786f94d6))
* **terraform:** set null value as fallback for missing variables ([#7669](https://github.com/aquasecurity/trivy-test/issues/7669)) ([611558e](https://github.com/aquasecurity/trivy-test/commit/611558e4ce61818330118684274534f26b1fda99))
