...
## [0.70.0](https://github.com/aquasecurity/trivy-test/compare/v0.69.0...v0.70.0) (2026-03-03)


### ⚠ BREAKING CHANGES

* **misconf:** use ID instead of AVDID for providers mapping ([#9752](https://github.com/aquasecurity/trivy-test/issues/9752))

### Features

* **activestate:** add support ActiveState images ([#10081](https://github.com/aquasecurity/trivy-test/issues/10081)) ([676709d](https://github.com/aquasecurity/trivy-test/commit/676709de44639e6c4329e1c69ee34a5e2760555f))
* add AnalyzedBy field to track which analyzer detected packages ([#10059](https://github.com/aquasecurity/trivy-test/issues/10059)) ([1953824](https://github.com/aquasecurity/trivy-test/commit/195382400fc9bf93cf303910453d44f6ba3b5dad))
* add ArtifactID field to uniquely identify scan targets ([#9663](https://github.com/aquasecurity/trivy-test/issues/9663)) ([84a7d9a](https://github.com/aquasecurity/trivy-test/commit/84a7d9a5d6880ef4248ead6bcf2e580deed9107b))
...
* add ReportID field to scan reports ([#9670](https://github.com/aquasecurity/trivy-test/issues/9670)) ([fc976be](https://github.com/aquasecurity/trivy-test/commit/fc976bea480599e52365d306ad8d6031718d4303))
...
* **aws:** Add support for dualstack ECR endpoints ([#9862](https://github.com/aquasecurity/trivy-test/issues/9862)) ([e74e2b1](https://github.com/aquasecurity/trivy-test/commit/e74e2b1b0a8ca124b1299969abc9196789f30e8b))
...
* **cli:** Add trivy cloud suppport ([#9637](https://github.com/aquasecurity/trivy-test/issues/9637)) ([8e6a7ff](https://github.com/aquasecurity/trivy-test/commit/8e6a7ff670c64106d4dea6972ac3f6228f9c6269))
...
* **cloudformation:** add support for Fn::ForEach ([#9508](https://github.com/aquasecurity/trivy-test/issues/9508)) ([d65b504](https://github.com/aquasecurity/trivy-test/commit/d65b504cb24a4d71f054bfbd6a872b58385bb0d3))
...
* **db:** enable concurrent access to vulnerability database ([#9750](https://github.com/aquasecurity/trivy-test/issues/9750)) ([d70d994](https://github.com/aquasecurity/trivy-test/commit/d70d994d8882a6e7a8b0c9a9b08524a2cae32ea4))
* **debian:** detect third-party packages using maintainer list ([#9917](https://github.com/aquasecurity/trivy-test/issues/9917)) ([effc1c0](https://github.com/aquasecurity/trivy-test/commit/effc1c0d4d46e01efa896f53ccc72eb87d175d91))
* **dotnet:** add dependency graph support for .deps.json files ([#9726](https://github.com/aquasecurity/trivy-test/issues/9726)) ([18c0ee8](https://github.com/aquasecurity/trivy-test/commit/18c0ee86f318c7d2b1dab979370f62dd00b73979))
...
* **flag:** add `--cacert` flag ([#9781](https://github.com/aquasecurity/trivy-test/issues/9781)) ([6048173](https://github.com/aquasecurity/trivy-test/commit/604817326683cdf5628550540aef63b97affc3b0))
* **flag:** add JSON Schema for trivy.yaml configuration file ([#9971](https://github.com/aquasecurity/trivy-test/issues/9971)) ([4caf731](https://github.com/aquasecurity/trivy-test/commit/4caf7312b63f93024c188f243cda957d97b30a88))
...
* **go:** detect version from ELF symbol table for binaries built with -trimpath ([#10197](https://github.com/aquasecurity/trivy-test/issues/10197)) ([7acb5f6](https://github.com/aquasecurity/trivy-test/commit/7acb5f6f095a11cb9911af5a0bc03aecc7c88f8f))
...
* **helm:** add sslCertDir parameter ([#9697](https://github.com/aquasecurity/trivy-test/issues/9697)) ([879e4fc](https://github.com/aquasecurity/trivy-test/commit/879e4fca12b53010e3b6a22fcb9c6e2b8eefad96))
...
* **image:** add RepoTags support for Docker archives ([#9690](https://github.com/aquasecurity/trivy-test/issues/9690)) ([a9a3031](https://github.com/aquasecurity/trivy-test/commit/a9a3031675150e70a32df8d55b4aec2c4a33084b))
* **image:** add Sigstore bundle SBOM support ([#9516](https://github.com/aquasecurity/trivy-test/issues/9516)) ([e1f3f28](https://github.com/aquasecurity/trivy-test/commit/e1f3f28ae4b86dd7f518a261080dc8d24ac2cdad))
* **image:** pass global context to docker/podman image save func ([#9733](https://github.com/aquasecurity/trivy-test/issues/9733)) ([2690ac9](https://github.com/aquasecurity/trivy-test/commit/2690ac99341dcdf06eb16316d3ca20e6070969b3))
* include registry and repository in artifact ID calculation ([#9689](https://github.com/aquasecurity/trivy-test/issues/9689)) ([758f271](https://github.com/aquasecurity/trivy-test/commit/758f2710403d5f0e9b3e138a604f95cbcab6f275))
* **java:** add support for proxy configuration from Maven settings.xml ([#10187](https://github.com/aquasecurity/trivy-test/issues/10187)) ([350fe33](https://github.com/aquasecurity/trivy-test/commit/350fe3345129f0f341ab80438f66f951b602364a))
* **java:** add support remote repositories from settings.xml files ([#9708](https://github.com/aquasecurity/trivy-test/issues/9708)) ([eff52eb](https://github.com/aquasecurity/trivy-test/commit/eff52eb2e60a700d831cbc3d260217162b38e45c))
...
* **julia:** enable vulnerability scanning for the Julia language ecosystem ([#9800](https://github.com/aquasecurity/trivy-test/issues/9800)) ([c2f82ad](https://github.com/aquasecurity/trivy-test/commit/c2f82add3a59a509f581cc245630ce29e801de6a))
...
* **license:** Support compound licenses (licenses using SPDX operators) ([#8816](https://github.com/aquasecurity/trivy-test/issues/8816)) ([39f9ed1](https://github.com/aquasecurity/trivy-test/commit/39f9ed128b2c0fb599ad9092a3cf5675106bffdc))
* **license:** use separate SPDX ids to ignore SPDX expressions ([#9087](https://github.com/aquasecurity/trivy-test/issues/9087)) ([012f3d7](https://github.com/aquasecurity/trivy-test/commit/012f3d75359e019df1eb2602460146d43cb59715))
...
* **misconf:** adapt ARM k8s clusters ([#9696](https://github.com/aquasecurity/trivy-test/issues/9696)) ([#10125](https://github.com/aquasecurity/trivy-test/issues/10125)) ([66bdec4](https://github.com/aquasecurity/trivy-test/commit/66bdec4f6af6100b6ab991ca417b0c801cb5cd80))
* **misconf:** add action block to Terraform schema ([#10035](https://github.com/aquasecurity/trivy-test/issues/10035)) ([b06ef6d](https://github.com/aquasecurity/trivy-test/commit/b06ef6d2706fddb5b9c5bc42c7d26598eb105f28))
* **misconf:** add agentpools to azure container schema ([#9714](https://github.com/aquasecurity/trivy-test/issues/9714)) ([69f400c](https://github.com/aquasecurity/trivy-test/commit/69f400c1839cc16013f2af3d1942c86f496e7017))
...
* **misconf:** Add RoleAssignments attribute ([#9396](https://github.com/aquasecurity/trivy-test/issues/9396)) ([3fb8703](https://github.com/aquasecurity/trivy-test/commit/3fb8703f8cd659a36d6a9affe0d2e20cd752a1e4))
...
* **misconf:** Add support for configurable Rego error limit ([#9657](https://github.com/aquasecurity/trivy-test/issues/9657)) ([445cd2b](https://github.com/aquasecurity/trivy-test/commit/445cd2b6b4faf78349245bc6541176e2fbf88715))
...
* **misconf:** include map key in manifest snippet for diagnostics ([#9681](https://github.com/aquasecurity/trivy-test/issues/9681)) ([197c9e1](https://github.com/aquasecurity/trivy-test/commit/197c9e1dce450737fc705184eed4c24fcfc1ecc1))
* **misconf:** initial ansible scanning support ([#9332](https://github.com/aquasecurity/trivy-test/issues/9332)) ([9275e15](https://github.com/aquasecurity/trivy-test/commit/9275e1532b11c5f1842f334660303a7ebf46a2c6))
...
* **misconf:** resolve Azure resources via resource_id ([#10173](https://github.com/aquasecurity/trivy-test/issues/10173)) ([823f363](https://github.com/aquasecurity/trivy-test/commit/823f3634ae8f41a17be8695ceabcb8ca52f82a63))
* **misconf:** support for ARM resources defined as an object ([#9959](https://github.com/aquasecurity/trivy-test/issues/9959)) ([92d3465](https://github.com/aquasecurity/trivy-test/commit/92d3465cee297cad6f6e1efbb4597676e081c275))
* **misconf:** support for azurerm_*_web_app ([#9944](https://github.com/aquasecurity/trivy-test/issues/9944)) ([37b5da8](https://github.com/aquasecurity/trivy-test/commit/37b5da895bcac45a617fee00f9de2bececb3b26a))
* **misconf:** support for azurerm_network_interface_security_group_association  ([#10215](https://github.com/aquasecurity/trivy-test/issues/10215)) ([da94d5f](https://github.com/aquasecurity/trivy-test/commit/da94d5f38676885264787fe22f3ed8ab42511b2a))
* **misconf:** support https_traffic_only_enabled in Az storage account ([#9784](https://github.com/aquasecurity/trivy-test/issues/9784)) ([c8d5ab7](https://github.com/aquasecurity/trivy-test/commit/c8d5ab7690b63a0af14d648eacabc62b868fdfe9))
* **misconf:** Update AppService schema ([#9792](https://github.com/aquasecurity/trivy-test/issues/9792)) ([c6d95d7](https://github.com/aquasecurity/trivy-test/commit/c6d95d7cd271c3d29ce147f1ad5983cafc1caf48))
* **misconf:** Update Azure Compute schema ([#9675](https://github.com/aquasecurity/trivy-test/issues/9675)) ([cb58bf6](https://github.com/aquasecurity/trivy-test/commit/cb58bf639eaea0a94584b4afbefe19d0010eef38))
* **misconf:** Update Azure Container Schema ([#9673](https://github.com/aquasecurity/trivy-test/issues/9673)) ([43a7546](https://github.com/aquasecurity/trivy-test/commit/43a7546d31f2cc8dd5f8d68f82822aff1bddc4d2))
* **misconf:** Update Azure Database schema ([#9811](https://github.com/aquasecurity/trivy-test/issues/9811)) ([48dfede](https://github.com/aquasecurity/trivy-test/commit/48dfedeb1e13d1654e2b9239f403d847af353e2e))
* **misconf:** Update Azure network schema for new checks ([#9791](https://github.com/aquasecurity/trivy-test/issues/9791)) ([ea2dc58](https://github.com/aquasecurity/trivy-test/commit/ea2dc586b83fec6eac1b5de04fd9e5a06db4e16a))
* **misconf:** Update azure storage schema ([#9728](https://github.com/aquasecurity/trivy-test/issues/9728)) ([c3bfecf](https://github.com/aquasecurity/trivy-test/commit/c3bfecf3ef236f333ebf1ace7fa2f739fdcbdcca))
* **misconf:** Update SecurityCenter schema ([#9674](https://github.com/aquasecurity/trivy-test/issues/9674)) ([58819c5](https://github.com/aquasecurity/trivy-test/commit/58819c5285520b55bc6a5ed30aab82826aee3065))
* **misconf:** use Terraform plan configuration to partially restore schema ([#9623](https://github.com/aquasecurity/trivy-test/issues/9623)) ([5fced3a](https://github.com/aquasecurity/trivy-test/commit/5fced3ae492281f0fe000e5ccf3c634425c008d8))
* **nodejs:** add a bun.lock analyzer ([#8897](https://github.com/aquasecurity/trivy-test/issues/8897)) ([7ca656d](https://github.com/aquasecurity/trivy-test/commit/7ca656d54b99346253fc6ac6422eecaca169514e))
...
* **nodejs:** parse licenses from `package-lock.json` file ([#9983](https://github.com/aquasecurity/trivy-test/issues/9983)) ([b64d5ad](https://github.com/aquasecurity/trivy-test/commit/b64d5adc6b90fde205e4eeaf7b58332bf10372d2))
* **php:** add support for dev dependencies in Composer ([#9910](https://github.com/aquasecurity/trivy-test/issues/9910)) ([56b59e8](https://github.com/aquasecurity/trivy-test/commit/56b59e8abbb891564bf03608b8150bceaeb60ded))
* **python:** add pylock.toml (PEP 751) parser ([#9632](https://github.com/aquasecurity/trivy-test/issues/9632)) ([1a72b32](https://github.com/aquasecurity/trivy-test/commit/1a72b326bba9e0959d5f3b63367bb311f064d795))
* **python:** add pylock.toml support ([#10137](https://github.com/aquasecurity/trivy-test/issues/10137)) ([d0a3f63](https://github.com/aquasecurity/trivy-test/commit/d0a3f63b84e6a8cd9067e85344097f9179c14b0d))
...
* **report:** add fingerprint generation for vulnerabilities ([#9794](https://github.com/aquasecurity/trivy-test/issues/9794)) ([cbad9ca](https://github.com/aquasecurity/trivy-test/commit/cbad9ca3a888cb3fb6b8649e683efe4f7047a8ed))
* **report:** add image reference to report metadata ([#9729](https://github.com/aquasecurity/trivy-test/issues/9729)) ([d020f26](https://github.com/aquasecurity/trivy-test/commit/d020f2690e58c328f96e3083ce57fe2b71f308f3))
* **report:** add Trivy version to JSON output ([#10065](https://github.com/aquasecurity/trivy-test/issues/10065)) ([fe7d20a](https://github.com/aquasecurity/trivy-test/commit/fe7d20a31c02b7ce61d85d264883831208132002))
* **report:** switch ReportID from UUIDv4 to UUIDv7 ([#9749](https://github.com/aquasecurity/trivy-test/issues/9749)) ([6fb3fde](https://github.com/aquasecurity/trivy-test/commit/6fb3fde916f991ccca8f23e18ab4d46e0780e50d))
* **rocky:** enable modular package vulnerability detection ([#10069](https://github.com/aquasecurity/trivy-test/issues/10069)) ([31c4780](https://github.com/aquasecurity/trivy-test/commit/31c4780f720c5adeb6488440406dc7fad7637dae))
* **rootio:** Update trivy db to support usage of Severity from root.io feed ([#9930](https://github.com/aquasecurity/trivy-test/issues/9930)) ([d3096e7](https://github.com/aquasecurity/trivy-test/commit/d3096e7617a6b5d6bc5beb2abce1b18a70c05c08))
...
* **sbom:** add support for SPDX attestations ([#9829](https://github.com/aquasecurity/trivy-test/issues/9829)) ([d8eaaeb](https://github.com/aquasecurity/trivy-test/commit/d8eaaeb611151f1da3583ec50100a7be09ce9bc5))
...
* **sbom:** exclude PEP 770 SBOMs in .dist-info/sboms/ ([#10033](https://github.com/aquasecurity/trivy-test/issues/10033)) ([07ff788](https://github.com/aquasecurity/trivy-test/commit/07ff7885df5397531271b837d4d9402a7d58e8a3))
* **sbom:** use SPDX license IDs list to validate SPDX IDs  ([#9569](https://github.com/aquasecurity/trivy-test/issues/9569)) ([35db88c](https://github.com/aquasecurity/trivy-test/commit/35db88c81cc5cdb8ab25362aea455c586d2e1d32))
...
* **secret:** add detection for Symfony default secret key ([#9892](https://github.com/aquasecurity/trivy-test/issues/9892)) ([34baef2](https://github.com/aquasecurity/trivy-test/commit/34baef28ecb31c7a9ba414a118b220da97b29634))
...
* **server:** include server version info in JSON output for client/server mode ([#10075](https://github.com/aquasecurity/trivy-test/issues/10075)) ([4c46d41](https://github.com/aquasecurity/trivy-test/commit/4c46d418c58c9a070a87b9d3c88966d40e435329))
* **suse:** Add new openSUSE, Micro and SLES releases end of life dates ([#9788](https://github.com/aquasecurity/trivy-test/issues/9788)) ([019af7f](https://github.com/aquasecurity/trivy-test/commit/019af7fefdc1da55610446ca07f13b2ea84348b5))
...
* **ubuntu:** add end of life date for Ubuntu 25.04 ([#9077](https://github.com/aquasecurity/trivy-test/issues/9077)) ([367564a](https://github.com/aquasecurity/trivy-test/commit/367564a3bec0c202566c59598dcff087bf50a23d))
* **ubuntu:** add eol data for 25.10 ([#10181](https://github.com/aquasecurity/trivy-test/issues/10181)) ([2c1f65b](https://github.com/aquasecurity/trivy-test/commit/2c1f65bdeec62baef45e93f58cc8e5eca7d84d26))
...
* **vex:** support per-repo tls configuration ([#10030](https://github.com/aquasecurity/trivy-test/issues/10030)) ([f809066](https://github.com/aquasecurity/trivy-test/commit/f809066b0745769876be8006e00dcf44017ffe96))
...
* **vuln:** skip third-party packages in common Detect function ([#10129](https://github.com/aquasecurity/trivy-test/issues/10129)) ([d6e6331](https://github.com/aquasecurity/trivy-test/commit/d6e6331abba28fe22f6d8d3bc36f7821601ff8ad))
* **vuln:** skip vulnerability scanning for third-party packages in Debian/Ubuntu ([#9932](https://github.com/aquasecurity/trivy-test/issues/9932)) ([74819bf](https://github.com/aquasecurity/trivy-test/commit/74819bf45733eda0a8377c40d09a60daefe9210a))
...
* close all opened resources if an error occurs ([#9665](https://github.com/aquasecurity/trivy-test/issues/9665)) ([fa6f779](https://github.com/aquasecurity/trivy-test/commit/fa6f77902234f5bee70287a841e8cfa42ca4a505))
...
* **docker:** fix non-det scan results for images with embedded SBOM ([#9866](https://github.com/aquasecurity/trivy-test/issues/9866)) ([7f71b57](https://github.com/aquasecurity/trivy-test/commit/7f71b577a0e138fc2908f9a8c2932b11004041db))
...
* **flag:** remove viper.SetDefault to fix IsSet() for config-only flags ([#9732](https://github.com/aquasecurity/trivy-test/issues/9732)) ([bf43629](https://github.com/aquasecurity/trivy-test/commit/bf43629d320426b18e7177b4b6f05affb6f93374))
...
* **go:** use ldflags version for all pseudo-versions    ([#10037](https://github.com/aquasecurity/trivy-test/issues/10037)) ([3c0ab97](https://github.com/aquasecurity/trivy-test/commit/3c0ab97e10dc451a7fb91ef6283a932c9c4db6bf))
* **image:** race condition in image artifact inspection ([#9966](https://github.com/aquasecurity/trivy-test/issues/9966)) ([18acf4f](https://github.com/aquasecurity/trivy-test/commit/18acf4f71dfa0668b0fe8b0ffcafd960f88b46d1))
...
* **java:** add hash of GAV+root pom file path for pkgID for packages from pom.xml files ([#9880](https://github.com/aquasecurity/trivy-test/issues/9880)) ([809db46](https://github.com/aquasecurity/trivy-test/commit/809db462317fb43317e2d4f7116a8e96c1b2a728))
* **java:** correctly inherit properties from parent fields for pom.xml files ([#9111](https://github.com/aquasecurity/trivy-test/issues/9111)) ([2933b01](https://github.com/aquasecurity/trivy-test/commit/2933b01cd55bc73ab99e6e867532093f2d65c94f))
* **java:** correctly propagate repositories from upper POMs to dependencies ([#10077](https://github.com/aquasecurity/trivy-test/issues/10077)) ([b9415a3](https://github.com/aquasecurity/trivy-test/commit/b9415a309cf6bd34505afcda05dc0b0ad8b78059))
* **java:** Disable overwriting exclusions ([#10088](https://github.com/aquasecurity/trivy-test/issues/10088)) ([9a3e0a8](https://github.com/aquasecurity/trivy-test/commit/9a3e0a845db68a79f4fd0e71f5cb7d8ca3976bbe))
...
* **java:** update order for resolving package fields from multiple demManagement ([#9575](https://github.com/aquasecurity/trivy-test/issues/9575)) ([e286c5e](https://github.com/aquasecurity/trivy-test/commit/e286c5e207b6d8a1ef01f3f634f874e2e3d4c0f0))
* **java:** use `true` as default value for Repository Release|Snapshot Enabled in pom.xml and settings.xml files ([#9751](https://github.com/aquasecurity/trivy-test/issues/9751)) ([d87d9b9](https://github.com/aquasecurity/trivy-test/commit/d87d9b97d1a61d05a9b1742caaa7e0125c481e2c))
...
* **license:** handle SPDX WITH exceptions as single license in category detection ([#9380](https://github.com/aquasecurity/trivy-test/issues/9380)) ([212f078](https://github.com/aquasecurity/trivy-test/commit/212f0781c552cd0395791a4a0276e1e39579f491))
...
* **license:** normalize licenses for PostAnalyzers ([#9941](https://github.com/aquasecurity/trivy-test/issues/9941)) ([11dd3fa](https://github.com/aquasecurity/trivy-test/commit/11dd3fac3825b45e5d4c5dd473f18c0c76e18bf5))
...
* **misconf:** apply check aliases when filtering results via .trivyignore ([#10112](https://github.com/aquasecurity/trivy-test/issues/10112)) ([b775a1b](https://github.com/aquasecurity/trivy-test/commit/b775a1b63cd7afeda8dec2c1c8b8b6d422418bc6))
...
* **misconf:** correct typos in block and attribute names ([#9993](https://github.com/aquasecurity/trivy-test/issues/9993)) ([ac061f8](https://github.com/aquasecurity/trivy-test/commit/ac061f8e887ab5a415b8c13474493c0541a48317))
...
* **misconf:** ensure boolean metadata values are correctly interpreted ([#9770](https://github.com/aquasecurity/trivy-test/issues/9770)) ([a6ceff7](https://github.com/aquasecurity/trivy-test/commit/a6ceff7e83121e2c9e618dcb0584aa62e7077bbf))
...
* **misconf:** ensure value used as ignore marker is non-null and known ([#9835](https://github.com/aquasecurity/trivy-test/issues/9835)) ([7aca801](https://github.com/aquasecurity/trivy-test/commit/7aca80151c2073999aa43213ae03a86b3d13a54c))
...
* **misconf:** handle unsupported experimental flags in Dockerfile ([#9769](https://github.com/aquasecurity/trivy-test/issues/9769)) ([08d51a8](https://github.com/aquasecurity/trivy-test/commit/08d51a8e08c1c7f159ca491810d0d08dc787f93e))
* **misconf:** initialize custom annotation field if empty ([#10123](https://github.com/aquasecurity/trivy-test/issues/10123)) ([0f0d6db](https://github.com/aquasecurity/trivy-test/commit/0f0d6dbff4825f7b0ea7744b2229e0157af52972))
* **misconf:** map healthcheck start period flag to --start-period instead of --startPeriod ([#9837](https://github.com/aquasecurity/trivy-test/issues/9837)) ([7b2b4d4](https://github.com/aquasecurity/trivy-test/commit/7b2b4d4b459358ed0f561aa30639282211c80cc1))
...
* **misconf:** respect .yml files when Helm charts are detected ([#9912](https://github.com/aquasecurity/trivy-test/issues/9912)) ([18ecf75](https://github.com/aquasecurity/trivy-test/commit/18ecf75176a1cadcf20e088a991af899e96fe40b))
* **misconf:** safely parse rotation_period in google_kms_crypto_key ([#9980](https://github.com/aquasecurity/trivy-test/issues/9980)) ([a0ecc8e](https://github.com/aquasecurity/trivy-test/commit/a0ecc8e9267cb63ee3d2cd28c82561e39533031d))
...
* move enum into items for array-type fields in JSON Schema ([#10039](https://github.com/aquasecurity/trivy-test/issues/10039)) ([4e06c3d](https://github.com/aquasecurity/trivy-test/commit/4e06c3df5b77f92e5390dc7d3559036f1fdf6cad))
...
* **nodejs:** fix npmjs parser.pkgNameFromPath() panic issue ([#9688](https://github.com/aquasecurity/trivy-test/issues/9688)) ([231492d](https://github.com/aquasecurity/trivy-test/commit/231492db52ce69c8d9186b039b038bf0153f8dfa))
...
* **nodejs:** use the default ID format to match licenses in pnpm packages. ([#9661](https://github.com/aquasecurity/trivy-test/issues/9661)) ([804ea4a](https://github.com/aquasecurity/trivy-test/commit/804ea4aa575e486fd888f59c9ceb495857b57f8c))
...
* **os:** Add photon 5.0 in supported OS ([#9724](https://github.com/aquasecurity/trivy-test/issues/9724)) ([29f0347](https://github.com/aquasecurity/trivy-test/commit/29f034796590bc6b7a17fa4fee8b43c822a77c13))
...
* remove trailing tab in statefulset template ([#9889](https://github.com/aquasecurity/trivy-test/issues/9889)) ([9db123c](https://github.com/aquasecurity/trivy-test/commit/9db123ccf80e55b30bee53db7163b9fd9a38bd75))
...
* **repo:** return a nil interface for gitAuth if missing ([#10097](https://github.com/aquasecurity/trivy-test/issues/10097)) ([036c05b](https://github.com/aquasecurity/trivy-test/commit/036c05b9a12eaccd7ebe8ee2f69d610fb7eea1fc))
* **report:** correct field order in SARIF license results ([#9712](https://github.com/aquasecurity/trivy-test/issues/9712)) ([d20216e](https://github.com/aquasecurity/trivy-test/commit/d20216edf6fdbd0281173b25b796880bc6b2b210))
...
* **rust:** add cargo workspace members glob support ([#10032](https://github.com/aquasecurity/trivy-test/issues/10032)) ([d2dc46a](https://github.com/aquasecurity/trivy-test/commit/d2dc46ad60178371ff9e1099bc8cbe838e1190ad))
* **rust:** implement version inheritance for Cargo mono repos ([#10011](https://github.com/aquasecurity/trivy-test/issues/10011)) ([47d3103](https://github.com/aquasecurity/trivy-test/commit/47d3103c50d455df02c299d0f3e954b61e77fc8e))
* **sbom:** add `buildInfo` info as properties ([#9683](https://github.com/aquasecurity/trivy-test/issues/9683)) ([2c43425](https://github.com/aquasecurity/trivy-test/commit/2c43425e051d80d45169a2c675dba79caa91b1e7))
...
* **sbom:** don’t panic on SBOM format if scanned CycloneDX file has empty metadata ([#9562](https://github.com/aquasecurity/trivy-test/issues/9562)) ([fb0593b](https://github.com/aquasecurity/trivy-test/commit/fb0593bee68a24b7ecddeb737e1d8e3c3a3c0364))
...
* **secret:** improve word boundary detection for Hugging Face tokens ([#10046](https://github.com/aquasecurity/trivy-test/issues/10046)) ([cdb28ee](https://github.com/aquasecurity/trivy-test/commit/cdb28eeeb176684e5b62b1bafbaf52e4cea79d4a))
...
* **server:** exclude JavaDB and CheckBundle from /version endpoint ([#10100](https://github.com/aquasecurity/trivy-test/issues/10100)) ([b9a8d2d](https://github.com/aquasecurity/trivy-test/commit/b9a8d2d80adc47bf9f48e13c2738b099c907518b))
...
* Trim the end-of-range suffix ([#9618](https://github.com/aquasecurity/trivy-test/issues/9618)) ([e18b038](https://github.com/aquasecurity/trivy-test/commit/e18b038ee2dce6c239246592fcef769853c11660))
...
* update all documentation links ([#9777](https://github.com/aquasecurity/trivy-test/issues/9777)) ([738b2b4](https://github.com/aquasecurity/trivy-test/commit/738b2b474a8ca94386a558c66442d8632acdce3c))
* update cosing settings for GoReleaser after bumping cosing to v3 ([#9863](https://github.com/aquasecurity/trivy-test/issues/9863)) ([c7accc8](https://github.com/aquasecurity/trivy-test/commit/c7accc85c66c27ec5c51b33acda97f4002cad584))
* update PhotonOS feed URL ([#10122](https://github.com/aquasecurity/trivy-test/issues/10122)) ([fa195b4](https://github.com/aquasecurity/trivy-test/commit/fa195b4d11d946b0212900b2a153a1abf381e8a2))
* Use `fetch-level: 1` to check out trivy-repo in the release workflow ([#9636](https://github.com/aquasecurity/trivy-test/issues/9636)) ([6e53686](https://github.com/aquasecurity/trivy-test/commit/6e53686526ef21e8a347fc07daa2f628e24eb9e5))
* use canonical SPDX license IDs from embeded licenses.json ([#10053](https://github.com/aquasecurity/trivy-test/issues/10053)) ([c233735](https://github.com/aquasecurity/trivy-test/commit/c233735b023974c0a5c321c370c7f3ebe5f20eec))
* use context for analyzers ([#9538](https://github.com/aquasecurity/trivy-test/issues/9538)) ([b885d3a](https://github.com/aquasecurity/trivy-test/commit/b885d3a3693a62bd2f506aeb238025242735ef1d))
...
* **vex:** add CVE-2025-66564 as not_affected into Trivy VEX file ([#9924](https://github.com/aquasecurity/trivy-test/issues/9924)) ([335cc99](https://github.com/aquasecurity/trivy-test/commit/335cc993fa76cddf2e263cb8e09d0cbbb0b98a09))
...
* **vex:** use a separate `visited` set for each DFS path ([#9760](https://github.com/aquasecurity/trivy-test/issues/9760)) ([c274f5b](https://github.com/aquasecurity/trivy-test/commit/c274f5b986afb82a805f1f6d3a79d44231a7edf6))
...
* **vuln:** skip vulns detection for CentOS Stream family without scan failure ([#9964](https://github.com/aquasecurity/trivy-test/issues/9964)) ([b46cde0](https://github.com/aquasecurity/trivy-test/commit/b46cde0ebe651cfad461fcde510cfe8b847391c3))
...
* **misconf:** optimize string concatenation in azure scanner ([#9969](https://github.com/aquasecurity/trivy-test/issues/9969)) ([10a50a7](https://github.com/aquasecurity/trivy-test/commit/10a50a7429dd18377747c54db53fc68c376135d7))
...
* **misconf:** use ID instead of AVDID for providers mapping ([#9752](https://github.com/aquasecurity/trivy-test/issues/9752)) ([6462dc8](https://github.com/aquasecurity/trivy-test/commit/6462dc8a5888003de0d08a5a2b2eb8ce464b6ae2))
